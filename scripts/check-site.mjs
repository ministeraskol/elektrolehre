...
export const checks = [
  ...
  ['Entdecken: Banner ×3, Empfohlen ×3 (je Stufe, Karten ≥ 4/4/4), Themen ≥ 5 Bereiche, Werkzeug 3 Karten (Wörterbuch da, Marken erst Task 6), Marken-Block ab Task 5, kein Video', () => { const h = read('de/entdecken'); return (h.match(/class="banner(?: astro-[\w-]+)?"/g) || []).length === 3 && ['einstieg', 'azubi', 'profi'].every((s) => new RegExp(`data-block="empfohlen" data-fuer="${s}"`).test(h)) && (h.match(/class="ww-karte karte"/g) || []).length >= 26 && (h.match(/class="ww-karte bereich(?: astro-[\w-]+)?"/g) || []).length >= 5 && (h.match(/class="ww-karte werkzeug-karte(?: astro-[\w-]+)?"/g) || []).length === 3 && !h.includes('data-block="neu"') && !h.includes('class="video'); }],
